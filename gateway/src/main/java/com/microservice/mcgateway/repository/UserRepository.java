package com.microservice.mcgateway.repository;
...
public class UserRepository {
    ...
    public UserRepository(ReactiveCassandraTemplate cqlTemplate, ReactiveSession session, Validator validator) {
        ...
        findOneByActivationKeyStmt =
            session.prepare("SELECT id " + "FROM user_by_activation_key " + "WHERE activation_key = :activation_key").block();
        ...
        insertByActivationKeyStmt =
            session.prepare("INSERT INTO user_by_activation_key (activation_key, id) " + "VALUES (:activation_key, :id)").block();
        ...
        deleteByActivationKeyStmt =
            session.prepare("DELETE FROM user_by_activation_key " + "WHERE activation_key = :activation_key").block();
    ...
    public Mono<Void> deleteAll() {
        return Flux
            .just(truncateStmt, truncateByEmailStmt, truncateByLoginStmt, truncateByResetKeyStmt)
