...
@RestController
@RequestMapping("/api/mcgateway-kafka")
public class McgatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(McgatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public McgatewayKafkaResource(KafkaProperties kafkaProperties) {
